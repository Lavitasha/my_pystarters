...
# if you want to return specific item of a key in the dictionary
a=my_dictionary_of_stuff['stringy_things'][0]
...
for i, x_val in enumerate(x):
    if x_val<1 and y[i]>1:
        plt.scatter(x_val, y[i], color='r')
    else:
        plt.scatter(x_val, y[i],color='y')

# better way of doing it without the for loops.
